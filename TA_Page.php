...
<html lang="en">
    <head>
     ...
     <body>
        <h2>This is a teaching assistant webpage!</h2>
        ...
        <P>
            ...
            # execute the query
            $query = "SELECT cNum, year, semester, fname AS Insturctor_fName,  lname AS Insturctor_lName, TAFName, TALName
            FROM Course JOIN User ON (instructor_Identifier = Identifier) NATURAL JOIN Assists
            WHERE TA_Identifier = '$UserID';";
