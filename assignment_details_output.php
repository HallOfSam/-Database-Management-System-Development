...
<html lang="en">
    <head>
        <title>Assignment details Page</title>
    </head>

     <body>
        <h2>This is a assignment details webpage!</h2>


        <P>
            <?php

            # obtain information from user's input
            $cNum = $_POST['cNum'];
            $year = $_POST['year'];
            ...
            # execute the query
            $query = "SELECT * FROM Assignment WHERE cNum = '$cNum' AND year = '$year' AND semester = '$semester';";
